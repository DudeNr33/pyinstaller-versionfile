...
def main(args=None):
    ...
    if args.source_format == "yaml":
        ...
        raise exceptions.InputError(f"Unknown source type {args.source_format}")
...
def parse_args(args):
    ...
    parser.add_argument("--source-format", default="yaml", help="Define the source format expected in metadata_source")
